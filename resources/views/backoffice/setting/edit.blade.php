        ...
        <div class="col-md-12">
            ...
            <div class="card card-outline card-primary">
                <div class="card-header">
                    <div class="row flex justify-content-between mt-2">
                        ...
                        <div class="card-tools">
                            <a href="/backoffice/setting" class="btn btn-warning">
                ...
                <div class="card-body">
                    ...
                    <form action="/backoffice/setting/{{ $setting->id }}/update" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="setting_category_id"
                                        class="form-control select2 @if($errors->has('setting_category_id')) is-invalid @endif"
                                    ...
                                    <small class="help-block" style="color: red">{{
                                        $errors->first('setting_category_id') }}</small>
                                    @endif
                                </div>
                            </div>
                            <div class="col-md-9">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="content" id="description"
                                        ...
                                        placeholder="Konten">{!! $setting->content !!}</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Sampul</label>
                                    @if ($setting->image)
                                        <img src="{{ asset('storage/images/setting/'.$setting->image) }}" alt="" class="img-fluid image rounded d-block mb-3" 
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    ...
                                    <select name="setting_category_id"
                                        ...
                                        <option value="">-- Pilih Kategori Peraturan --</option>
                                        @foreach ($settingCategories as $settingCategory)
                                        <option value="{{ $settingCategory->id }}">{{ $settingCategory->name }}</option>
                                        @endforeach
                                    </select>
                                    @if($errors->has('setting_category_id'))
                                    <small class="help-block" style="color: red">{{
