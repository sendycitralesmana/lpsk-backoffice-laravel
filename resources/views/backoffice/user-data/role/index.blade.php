            ...
            <div class="card card-outline card-primary">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        ...
                        {{-- Modal --}}
                        @include('backoffice.user-data.role.modal.add')
                ...
                <div class="card-body">
                    ...
                    @foreach ($roles as $role)
                        @include('backoffice.user-data.role.modal.edit')
                        @include('backoffice.user-data.role.modal.delete')
                    @endforeach
