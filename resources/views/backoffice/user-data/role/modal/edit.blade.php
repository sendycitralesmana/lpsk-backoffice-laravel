<div class="modal fade" id="edit-{{ $role->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <form role="form" method="POST" action="/backoffice/user-data/role/{{ $role->id }}/update" enctype="multipart/form-data">
                {{ csrf_field() }}
                @method('PUT')
                    ...
                    <div class="card card-outline card-primary">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text"  name="role" class="form-control @if($errors->has('role')) is-invalid @endif" value="{{ $role->name }}"
