<div class="modal fade" id="add-document-{{ $news->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <form role="form" method="POST" action="/backoffice/news/{{ $news->id }}/document/create" enctype="multipart/form-data">
                {{ csrf_field() }}
