        ...
        <div class="col-md-12">
            ...
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    ...
                    <form action="/backoffice/news/{{ $news->id }}/update" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title"
                                        ...
                                        placeholder="Judul" value="{{ $news->title }}" required
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Sampul</label>
                                    @if ($news->image)
                                        <img src="{{ asset('storage/images/news/'.$news->image) }}" alt="" class="img-fluid image rounded d-block mb-3" 
