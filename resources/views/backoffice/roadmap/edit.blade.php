        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item active">Edit Peta Jalan</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    ...
                    <form action="/backoffice/roadmap/{{ $roadmap->id }}/update" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title"
                                        ...
                                        placeholder="Judul" value="{{ $roadmap->title }}" required
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="content" id="description"
                                        ...
                                        placeholder="Konten">{!! $roadmap->content !!}</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Sampul</label>
                                    @if ($roadmap->image)
                                        <img src="{{ asset('storage/images/roadmap/'.$roadmap->image) }}" alt="" class="img-fluid image rounded d-block mb-3" 
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="status" class="form-control @if($errors->has('status')) is-invalid @endif" 
                                        ...
                                        <option value="DIAJUKAN" {{ $roadmap->status == 'DIAJUKAN' ? 'selected' : '' }}>DIAJUKAN</option>
                                        <option value="DINAIKAN" {{ $roadmap->status == 'DINAIKAN' ? 'selected' : '' }}>DINAIKAN</option>
                                        <option value="DITURUNKAN" {{ $roadmap->status == 'DITURUNKAN' ? 'selected' : '' }}>DITURUNKAN</option>
                                    </select>
