...
<head>
    ...
    <link rel="stylesheet"
        href="{{asset('backoffice/assets/adminlte/plugins/datatables-responsive/css/responsive.bootstrap4.min.css')}}">
    <!-- Ionicons -->
    ...
    <div class="login-box">
        <div class="card">
            ...
            <div class="card-body login-card-body">
                ...
                <p class="login-box-msg">Masuk untuk mengakses halaman backoffice LPSK</p>
                @if(session('success'))
                ...
                <form action="/backoffice/login" method="POST">
                    ...
                    <div class="row">
                        <!-- /.col -->
                        <div class="col-12">
                            <button type="submit" class="btn btn-dark btn-block" style="color: aliceblue">
        ...
        <!-- AdminLTE App -->
        <script src="{{asset('backoffice/assets/adminlte/dist/js/adminlte.js')}}"></script>
        ...
        <script src="{{asset('backoffice/assets/adminlte/plugins/datatables-responsive/js/dataTables.responsive.min.js')}}">
        </script>
        <script src="{{asset('backoffice/assets/adminlte/plugins/datatables-responsive/js/responsive.bootstrap4.min.js')}}">
        </script>
